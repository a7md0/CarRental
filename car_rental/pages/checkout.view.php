    ...
    <div class="row g-5">
        <div class="col-md-5 col-lg-4 order-md-last">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span class="badge bg-primary rounded-pill"><?= count($salesInvoiceItems) ?></span>
            </h4>
            <ul class="list-group mb-3">
                <?php
                /** @var SalesInvoiceItem[] $salesInvoiceItems */
                foreach ($salesInvoiceItems as $salesInvoiceItem) { ?>
                    <li class="list-group-item d-flex justify-content-between lh-sm">
                        <div>
                            <h6 class="my-0"><?= $salesInvoiceItem->getItem() ?></h6>
                            <small class="text-muted"></small>
                        </div>
                        <span class="text-muted">BD<?= $salesInvoiceItem->getPrice() ?></span>
                    </li>
                <?php } ?>
                <?php if ($paidAmount > 0.000) { ?>
                    <li class="list-group-item d-flex justify-content-between bg-light">
                        <div class="text-success">
                            <h6 class="my-0">Paid</h6>
                            <small></small>
                        </div>
                        <span class="text-success">BD<?= $paidAmount ?></span>
                    </li>
                <?php } ?>
                <li class="list-group-item d-flex justify-content-between">
                    <span>Total</span>
                    <strong>BD<?= $totalAmount ?></strong>
                </li>
            </ul>
        </div>
            ...
            <form class="needs-validation" action="<?= $_SERVER['REQUEST_URI'] ?>" method="POST">
                <div class="row g-3">
                    ...
                    <div class="col-md-5">
                        ...
                        <select class="form-select" aria-label="Country" name="country" autocomplete="country-name" required>
