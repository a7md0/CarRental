...
{
    protected static $tableName = DB_TABLES_PREFIX . 'car_detail';
    ...
    static function initializeFromData(array $data)
    {
        ...
        $model->setCarModel(CarModel::initializeFromData($data));
        $model->setCarType(CarType::initializeFromData($data));
